            ...
            movieReviews.map(review => (
                <div key={review.id} className='review-box'>
                    <div className="review-user-info">
                        <img src={review.author_details.avatar_path.includes('gravatar') ? `https://www.gravatar.com/avatar/${review.author_details.avatar_path.slice(33, 200)}` : `${IMAGE_BASE_URL}w154${review.author_details.avatar_path}`} />
